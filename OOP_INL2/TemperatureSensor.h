...
// Här finns både deklaration och implementation av TemperatureSensor-klassen.
class TemperatureSensor : public Sensor {
public:
	TemperatureSensor(std::string id, double minV, double maxV) // Konstruktor
    ...
    std::string unit() const override { return "Celsius"; }
